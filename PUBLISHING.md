...
GitHub 源码预览；安装结果以固定提交对应的外部验收记录为准，不代表正式发行、宿主加载或业务验收通过。

## 上传什么

- 唯一业务真源：.agents/skills/chengfeng-videocut-cut/，含实际需要的 references、scripts、获许可 assets、公开样例与可复现测试。HTML、SVG、模板图片可以是必要资源。
